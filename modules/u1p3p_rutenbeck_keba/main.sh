...
#
## openwb.conf
#           charge1ip=<IpAddress of rutenbeck>||"none"
#           charge2ip=<IpAddress of rutenbeck>||"none"
#           ...
#           charge8ip=<IpAddress of rutenbeck>||"none"
#
...
#test begin - set config
#chargep1ip="192.168.15.18"
#charge1ip="1.2.3.4"
#test end
